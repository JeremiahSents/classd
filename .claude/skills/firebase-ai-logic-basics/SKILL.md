...
- Identify the platform the user is interested in building on prior to starting: Android, iOS, or Web.
...
Supported Platforms and Frameworks include Kotlin and Java for Android, Swift for iOS, JavaScript for web apps, and C Sharp for Unity.
...
> For all platforms (Android, iOS, Web), you MUST run `npx firebase-tools init ailogic` to provision the service.
